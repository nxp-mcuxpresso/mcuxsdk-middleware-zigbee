 ...
 *
 * COMPONENT:          door_lock_controller.c
 *
 * DESCRIPTION:        ZigBee Door Lock Controller profile functions
 *
 *****************************************************************************/
...
/****************************************************************************
 *
 * NAME: eHA_RegisterDoorLockControllerEndPoint
 *
 * DESCRIPTION:
 * Registers a Door Lock Controller device with the ZCL layer
 *
                                              ...
                                              tsHA_DoorLockControllerDevice *psDeviceInfo)
{
    ...
    psDeviceInfo->sEndPoint.u16NumberOfClusters = sizeof(tsHA_DoorLockControllerDeviceClusterInstances) / sizeof(tsZCL_ClusterInstance);
