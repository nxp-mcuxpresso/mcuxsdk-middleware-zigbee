...
/****************************************************************************
 *
 * NAME: eHA_RegisterDoorLockEndPoint
 *
 * DESCRIPTION:
                                              ...
                                              tsHA_DoorLockDevice *psDeviceInfo)
{
    ...
    psDeviceInfo->sEndPoint.u16NumberOfClusters = sizeof(tsHA_DoorLockDeviceClusterInstances) / sizeof(tsZCL_ClusterInstance);
