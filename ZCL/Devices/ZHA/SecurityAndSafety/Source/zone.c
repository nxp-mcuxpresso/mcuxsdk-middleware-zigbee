 ...
 * COMPONENT:          zone.c
 *
 * DESCRIPTION:        ZigBee IAS Zone device profile functions
 *
 *****************************************************************************/
...
/****************************************************************************
 *
 * NAME: eHA_RegisterIASZoneEndPoint
 *
 * DESCRIPTION:
                                                   ...
                                                   tsHA_IASZoneDevice *psDeviceInfo)
{
    ...
    psDeviceInfo->sEndPoint.u16NumberOfClusters = sizeof(tsHA_IASZoneDeviceClusterInstances) / sizeof(tsZCL_ClusterInstance);
    ...
    /* Create an instance of a Diagnostics server */
    eCLD_DiagnosticsCreateDiagnostics(
                          &psDeviceInfo->sClusterInstance.sDiagnosticsServer,
                          TRUE,
                          &sCLD_Diagnostics,
                          &psDeviceInfo->sDiagnosticsServerCluster,
                          &au8DiagnosticsClusterAttributeControlBits[0]);
#endif
    ...
    /* Mandatory Clusters supported by IAS Zone Server Device */
    ...
    if (eCLD_TemperatureMeasurementCreateTemperatureMeasurement(
    		&psDeviceInfo->sClusterInstance.sTempMeasurementServer,
		    TRUE,
			&sCLD_TemperatureMeasurement,
			&psDeviceInfo->sCLD_TempMeasurementServerCluster,
   ...
   if (eOTA_Create(
    ...
    if (eCLD_WWAHCreateWWAH(
            &psDeviceInfo->sClusterInstance.sWWAHServer,
            TRUE,
            &sCLD_WWAH,
            &psDeviceInfo->sWWAHServerCluster,
            &au8WWAHAttributeControlBits[0],
            &psDeviceInfo->sWWAHServerCustomDataStructure)!= E_ZCL_SUCCESS)
    {
        return E_ZCL_FAIL;
    }
