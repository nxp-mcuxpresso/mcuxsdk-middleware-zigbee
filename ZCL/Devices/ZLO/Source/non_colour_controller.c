 ...
 * COMPONENT:
 *
 * DESCRIPTION:        ZigBee Light Link Non Colour remote profile functions
 *
 *****************************************************************************/
...
#include "zps_apl.h"
#include "zcl_heap.h"
#include "non_colour_controller.h"
...
/****************************************************************************
 *
 * NAME: eZLO_RegisterNonColourControllerEndPoint
 *
 * DESCRIPTION:
 * Registers a none colour remote device with the ZCL layer
 *
                                              ...
                                              tsZLO_NonColourControllerDevice *psDeviceInfo)
{
    ...
    psDeviceInfo->sEndPoint.u16NumberOfClusters = sizeof(tsZLO_NonColourControllerDeviceClusterInstances) / sizeof(tsZCL_ClusterInstance);
