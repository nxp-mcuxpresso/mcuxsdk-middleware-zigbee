...
/****************************************************************************
 *
 * NAME: eZLO_RegisterOnOffSensorEndPoint
 *
 * DESCRIPTION:
                                              ...
                                              tsZLO_OnOffSensorDevice *psDeviceInfo)
{
    ...
    psDeviceInfo->sEndPoint.u16NumberOfClusters = sizeof(tsZLO_OnOffSensorDeviceClusterInstances) / sizeof(tsZCL_ClusterInstance);
