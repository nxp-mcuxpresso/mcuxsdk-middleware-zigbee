...
/****************************************************************************
 *
 * NAME: eZLO_RegisterDimmablePlugEndPoint
 *
 * DESCRIPTION:
                                              ...
                                              tsZLO_DimmablePlugDevice *psDeviceInfo)
{
    ...
    psDeviceInfo->sEndPoint.u16NumberOfClusters = sizeof(tsZLO_DimmablePlugDeviceClusterInstances) / sizeof(tsZCL_ClusterInstance);
