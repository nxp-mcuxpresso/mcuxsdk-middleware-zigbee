...
/****************************************************************************
 *
 * NAME: eZLO_RegisterLightSensorEndPoint
 *
 * DESCRIPTION:
                                              ...
                                              tsZLO_LightSensorDevice *psDeviceInfo)
{
    ...
    psDeviceInfo->sEndPoint.u16NumberOfClusters = sizeof(tsZLO_LightSensorDeviceClusterInstances) / sizeof(tsZCL_ClusterInstance);
    ...
    /* Optional Cluster not part of ZLO */
        ...
        eCLD_TemperatureMeasurementCreateTemperatureMeasurement(
                              ...
                              &au8TemperatureMeasurementAttributeControlBits[0]);
    #endif
