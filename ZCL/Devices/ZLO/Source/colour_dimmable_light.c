...
/****************************************************************************
 *
 * NAME: eZLO_RegisterColourDimmableLightEndPoint
 *
 * DESCRIPTION:
 * Registers a colour dimmable light device with the ZCL layer
 *
                                              ...
                                              tsZLO_ColourDimmableLightDevice *psDeviceInfo)
{
    ...
    psDeviceInfo->sEndPoint.u16NumberOfClusters = sizeof(tsZLO_ColourDimmableLightDeviceClusterInstances) / sizeof(tsZCL_ClusterInstance);
