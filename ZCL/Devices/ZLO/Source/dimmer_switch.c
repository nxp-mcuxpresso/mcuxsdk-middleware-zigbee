...
/****************************************************************************
 *
 * NAME: eZLO_RegisterDimmerSwitchEndPoint
 *
 * DESCRIPTION:
                                              ...
                                              tsZLO_DimmerSwitchDevice *psDeviceInfo)
{
    ...
    psDeviceInfo->sEndPoint.u16NumberOfClusters = sizeof(tsZLO_DimmerSwitchDeviceClusterInstances) / sizeof(tsZCL_ClusterInstance);
