...
/****************************************************************************
 *
 * NAME: eZLO_RegisterExtendedColourLightEndPoint
 *
 * DESCRIPTION:
 * Registers an Extended colour light device with the ZCL layer
 *
                                              ...
                                              tsZLO_ExtendedColourLightDevice *psDeviceInfo)
{
    ...
    psDeviceInfo->sEndPoint.u16NumberOfClusters = sizeof(tsZLO_ExtendedColourLightDeviceClusterInstances) / sizeof(tsZCL_ClusterInstance);
