 ...
 *
 * COMPONENT:          colour_dimmer_switch.h
 *
 * DESCRIPTION:        Header for ZigBee Colour Dimmer switch profile functions
 *
 *****************************************************************************/

#ifndef COLOUR_DIMMER_SWITCH_H
#define COLOUR_DIMMER_SWITCH_H
...
} tsZLO_ColourDimmerSwitchDeviceClusterInstances __attribute__ ((aligned(4)));


/* Holds everything required to create an instance of a colour dimmer switch */
typedef struct
{
