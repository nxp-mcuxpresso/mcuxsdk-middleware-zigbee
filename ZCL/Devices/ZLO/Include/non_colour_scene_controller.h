 ...
 *
 * COMPONENT:          none_colour_scene_controller.h
 *
 * DESCRIPTION:        Header for ZigBee Light Link Non Colour Scene Remote profile functions
 *
 *****************************************************************************/

#ifndef NON_COLOUR_SCENE_CONTROLLER_H
#define NON_COLOUR_SCENE_CONTROLLER_H
...
} tsZLO_NonColourSceneControllerDeviceClusterInstances __attribute__ ((aligned(4)));
...
#endif /* NON_COLOUR_SCENE_CONTROLLER_H */
