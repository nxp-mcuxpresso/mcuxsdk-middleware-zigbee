...
execute_process(
    COMMAND bash select_cmake_mode.sh legacy
    WORKING_DIRECTORY ${NXP_ZB_BASE}
)
...
if(CONFIG_ZB_BDB)
    list(APPEND ZB_APP_OPTIONAL_SOURCES
        ...
        ${NXP_ZB_BASE}/BDB/Source/TransportKeyDecider/bdb_tkd.c
...
execute_process(
    COMMAND bash select_cmake_mode.sh
    WORKING_DIRECTORY ${NXP_ZB_BASE}
)