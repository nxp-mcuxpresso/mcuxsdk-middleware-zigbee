...
#ifdef R23_UPDATES
#define ZPS_ZDP_MGMT_NWK_BEACON_SURVEY_REQ_CLUSTER_ID       (0x003c)
#endif
...
#ifdef R23_UPDATES
#define ZPS_ZDP_MGMT_NWK_BEACON_SURVEY_RSP_CLUSTER_ID       (0x803c)
#endif
...
#ifdef R23_UPDATES
#define ZPS_ZDP_ENHACTIVESCAN_CONFIG_MASK    1
#else
...
#ifdef R23_UPDATES
#define ZPS_ZDP_SECURITY_CONFIG_CHANNEL_CHANGE_EN    (1)
#define ZPS_ZDP_SECURITY_CONFIG_PANID_CHANGE_EN   (1<<1)
#define ZPS_ZDP_SECURITY_CONFIG_PARAMS_CHANGE_EN  (1<<2)
...
typedef struct
{
    ZPS_tsAplZdpScanChannelList sZdpScanChannelList;
    uint8                       u8ConfigMask;
} ZPS_tsAplZdpMgmtNwkBeaconSurveyReq;
#endif
...
#ifdef R23_UPDATES
typedef struct {
    uint32 u32NextChannelChange;
    uint16 u16NextPanidChange;
    uint16 u16ConfigParams;
    uint8  u8FieldValid;
} ZPS_tsAplZdpSecuritySetConfigReq;
...
typedef struct {
    ...
    tuProcessingStatusRsp *psTlv;
} ZPS_tsAplZdpSecuritySetConfigRsp;
...
#ifdef R23_UPDATES
PUBLIC ZPS_teStatus zps_eAplZdpMgmtNwkBeaconSurveyRequest(
    void *pvApl,
    PDUM_thAPduInstance hAPduInst,
    ZPS_tuAddress uDstAddr,
    bool bExtAddr,
    uint8 *pu8SeqNumber,
    ZPS_tsAplZdpMgmtNwkBeaconSurveyReq *psZdpMgmtNwkBeaconSurveyReq);

ZPS_teStatus zps_eZdpMgmtNwkBeaconSurveyResponse(
    void *pvApl,
    PDUM_thAPduInstance hAPduInst,
    ZPS_tuAddress uDstAddr,
    bool bExtAddr,
    uint8 u8SeqNumber,
    ZPS_tsAplZdpMgmtNwkBeaconSurveyRsp *psRspStruct,
    uint8 *pu8SeqNum);
#endif
...
#ifdef R23_UPDATES
PUBLIC ZPS_teStatus zps_eAplZdpSecuritySetConfigRequest(
    void *pvApl,
    PDUM_thAPduInstance hAPduInst,
    ZPS_tuAddress uDstAddr,
    bool bExtAddr,
    uint8 *pu8SeqNumber,
    ZPS_tsAplZdpSecuritySetConfigReq *psZdpSecuritySetConfigReq);

PUBLIC ZPS_teStatus zps_eAplZdpSecurityGetConfigRequest(
    void *pvApl,
    PDUM_thAPduInstance hAPduInst,
    ZPS_tuAddress uDstAddr,
    bool bExtAddr,
...
#ifdef R23_UPDATES
ZPS_APL_INLINE ZPS_teStatus ZPS_eAplZdpMgmtNwkBeaconSurveyRequest(
    PDUM_thAPduInstance hAPduInst,
    ZPS_tuAddress uDstAddr,
    bool bExtAddr,
    uint8 *pu8SeqNumber,
    ZPS_tsAplZdpMgmtNwkBeaconSurveyReq *psZdpMgmtNwkBeaconSurveyReq) ZPS_ZDP_ALWAYS_INLINE;
ZPS_APL_INLINE ZPS_teStatus ZPS_eAplZdpMgmtNwkBeaconSurveyRequest(
    PDUM_thAPduInstance hAPduInst,
    ZPS_tuAddress uDstAddr,
    bool bExtAddr,
    ...
    ZPS_tsAplZdpMgmtNwkBeaconSurveyReq *psZdpMgmtNwkBeaconSurveyReq)
{
    return zps_eAplZdpMgmtNwkBeaconSurveyRequest(ZPS_pvAplZdoGetAplHandle(), hAPduInst, uDstAddr, bExtAddr, pu8SeqNumber, psZdpMgmtNwkBeaconSurveyReq);
}
#endif
...
ZPS_APL_INLINE ZPS_teStatus ZPS_eAplZdpSecuritySetConfigRequest(
    PDUM_thAPduInstance hAPduInst,
    ZPS_tuAddress uDstAddr,
    bool bExtAddr,
    uint8 *pu8SeqNumber,
    ZPS_tsAplZdpSecuritySetConfigReq *psZdpSecuritySetConfigReq) ZPS_ZDP_ALWAYS_INLINE;
ZPS_APL_INLINE ZPS_teStatus ZPS_eAplZdpSecuritySetConfigRequest(
    PDUM_thAPduInstance hAPduInst,
    ZPS_tuAddress uDstAddr,
    bool bExtAddr,
    ...
    ZPS_tsAplZdpSecuritySetConfigReq *psZdpSecuritySetConfigReq)
{
    return zps_eAplZdpSecuritySetConfigRequest(ZPS_pvAplZdoGetAplHandle(), hAPduInst,
            uDstAddr, bExtAddr, pu8SeqNumber, psZdpSecuritySetConfigReq);
}

ZPS_APL_INLINE ZPS_teStatus ZPS_eAplZdpSecurityGetConfigRequest(
    PDUM_thAPduInstance hAPduInst,
    ZPS_tuAddress uDstAddr,
    bool bExtAddr,
    uint8 *pu8SeqNumber,
    ZPS_tsAplZdpSecurityGetConfigReq *psZdpSecurityGetConfigReq) ZPS_ZDP_ALWAYS_INLINE;
ZPS_APL_INLINE ZPS_teStatus ZPS_eAplZdpSecurityGetConfigRequest(
    PDUM_thAPduInstance hAPduInst,
    ZPS_tuAddress uDstAddr,
    bool bExtAddr,
