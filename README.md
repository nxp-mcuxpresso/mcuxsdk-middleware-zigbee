...
| `CONFIG_ZB_MANUFACTURER_CODE` | Manufacturer code used for OTA image generation | `0x0000-0xffff` | `0x1307` |
| `CONFIG_ZB_BOOTLOADER_MCUBOOT` | This option signifies the target uses MCUBoot as a bootloader | `boolean` | `OFF` |
| `CONFIG_ZB_MCUBOOT_SIGNATURE_KEY_FILE` | Path to the mcuboot signing key file | `NA` | `${NXP_SDK_MIDDLEWARE}/mcuboot_opensource/boot/nxp_mcux_sdk/keys/sign-rsa2048-priv.pem` |
