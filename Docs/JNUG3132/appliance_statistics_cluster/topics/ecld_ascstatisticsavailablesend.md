...
This function can be used on an Appliance Statistics cluster server to send an unsolicited ‘Statistics Available’ message to a cluster client. The function is an alternative to **eCLD\_ASCLogQueueResponseORStatisticsAvailableSend\(\)**.
