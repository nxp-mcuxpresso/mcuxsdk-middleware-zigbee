...
-   *psCustomDataStructure*: Pointer to a structure containing the storage for internal functions of the cluster \(see [Section 39.6.1](custom_data_structure.md#id_8cdaf8e2-1f50-4ccb-90a9-04684beec3fb)\)
