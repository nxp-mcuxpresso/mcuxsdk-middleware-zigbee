...
The outcome of the request will be returned by the server in a response which will generate an E\_CLD\_IASACE\_CMD\_BYPASS\_RESP event when received on the client.
