# eCLD\_IASACE\_GetPanelStatusSend
...
The requested information will be returned by the server in a response which will generate an E\_CLD\_IASACE\_CMD\_GET\_PANEL\_STATUS\_RESP event when received on the client.
