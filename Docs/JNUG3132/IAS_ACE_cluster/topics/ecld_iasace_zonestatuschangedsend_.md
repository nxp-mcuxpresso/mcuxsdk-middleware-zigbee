# eCLD\_IASACE\_ZoneStatusChangedSend
...
**Note:** This command is sent automatically when the function **eCLD\_IASACESetZoneParameter\(\)** is called on the server to update the `u16ZoneStatus` attribute for all the bound clients.
