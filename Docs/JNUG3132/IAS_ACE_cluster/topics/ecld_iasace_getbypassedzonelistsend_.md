# eCLD\_IASACE\_GetBypassedZoneListSend
...
The requested information will be returned by the server in a response which will generate an E\_CLD\_IASACE\_CMD\_SET\_BYPASSED\_ZONE\_LIST event when received on the client.
