# eCLD\_IASACE\_GetZoneIDMapSend
...
The requested information is returned by the server in a response which generates an E\_CLD\_IASACE\_CMD\_GET\_ZONE\_ID\_MAP\_RESP event when received on the client.
