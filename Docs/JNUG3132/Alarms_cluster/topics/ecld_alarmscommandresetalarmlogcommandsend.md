# eCLD\_AlarmsCommandResetAlarmLogCommandSend
...
On receiving the command, an E\_CLD\_ALARMS\_CMD\_RESET\_ALARM\_LOG event is generated on the cluster server to notify the application but the ZCL automatically clears the Alarms table.
