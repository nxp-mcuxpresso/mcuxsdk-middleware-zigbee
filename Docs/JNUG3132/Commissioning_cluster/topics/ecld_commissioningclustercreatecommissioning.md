# eCLD\_CommissioningClusterCreateCommissioning
...
-   *psCustomDataStructure*        Pointer to a structure containing the storage for internal functions of the cluster \(see [Section 43.9.5](tscld_commissioningcustomdatastructure.md#id_cbdf45e5-ddaa-4bf3-9868-cd09c332eacb)\)
