# eCLD\_LevelControlCommandMoveCommandSend
...
This function sends a Move command to instruct a device to move its ‘current level’ attribute either up or down in a continuous manner at a specified rate. The direction and rate are specified in the payload of the command \(see [Section 16.8.3](custom_command_payloads.md#id_f61514a8-3e23-4341-aa52-4969cab764ef)\).
