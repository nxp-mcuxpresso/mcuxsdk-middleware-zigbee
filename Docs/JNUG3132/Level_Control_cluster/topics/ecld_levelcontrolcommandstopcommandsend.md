# eCLD\_LevelControlCommandStopCommandSend
...
-   *psPayload*        Pointer to a structure containing the payload for this message \(see [Section 16.8.3.4](stop_command_payload.md#id_0a33cd03-ae17-4dfe-a769-a7d6148d2960)\)
