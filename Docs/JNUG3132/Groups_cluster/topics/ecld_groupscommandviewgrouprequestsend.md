# eCLD\_GroupsCommandViewGroupRequestSend
...
The device receiving this message generates a callback event on the endpoint on which the Groups cluster was registered and generates a View Group response containing the group name \(see [Section 12.6.4](custom_command_responses.md#id_2847a262-1f84-4006-aa7e-fc849bbfed55)\).
