...
-   *psCustomDataStructure*: Pointer to the structure that contains custom data for the Identify cluster \(see [Section 11.7.1](custom_data_structure.md#id_8c4539b3-363d-421a-9653-49e4c25391ce)\). This structure is used for internal data storage. No knowledge of the fields of this structure is required.
