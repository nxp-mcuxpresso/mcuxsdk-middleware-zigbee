# eSE\_PriceGetConversionFactorEntry
...
-   *ppsPublishConversionCmdPayload*:  Pointer to a pointer to a structure which will be used to store the obtained conversion factor information \(see [Section](tsse_pricepublishconversioncmdpayload.md#id_bd746256-2872-4a49-9815-bef2f9e5d5e5)40.11.2\), if found. The pointer value that is returned in this parameter points to the structure in the internal storage associated with the list. The data in the structure will be valid as long as the item remains in the list
