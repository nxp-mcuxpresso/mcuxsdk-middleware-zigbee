# eCLD\_AnalogInputBasicCreateAnalogInputBasic
...
The function initializesthe array elements to zero.
...
**Parent topic:**[Functions](../../Binary_Input_Basic_cluster/topics/functions.md)
