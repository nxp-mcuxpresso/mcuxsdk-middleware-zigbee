# eCLD\_IASZoneNormalOperationModeReqSend
...
This function can be used on IAS Zone cluster client to send a request the IAS Zone server to initiate normal operation mode. If required, this command must be enabled in the compile-time options, as described in [Section 37.7](compile-time_options.md#id_ad95ceff-e1ed-403a-bd1d-4c75db460c10).
