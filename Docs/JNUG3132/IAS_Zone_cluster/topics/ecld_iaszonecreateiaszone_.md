...
-   *psCustomDataStructure*: Pointer to a structure containing the storage for internal functions of the cluster \(see [Section 37.6.1](custom_data_structure.md#id_c30f6fc4-9c42-476c-b88f-8c8b721e4af0)\)
