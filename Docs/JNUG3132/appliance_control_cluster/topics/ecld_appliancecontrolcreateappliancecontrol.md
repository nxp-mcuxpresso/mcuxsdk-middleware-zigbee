# eCLD\_ApplianceControlCreateApplianceControl
...
-   *psCustomDataStructure* Pointer to a structure containing the storage for internal functions of the cluster \(see [Section 45.9.4](tscld_appliancecontrolcustomdatastructure.md#id_60484719-e0f2-48cf-a8a7-a8fc8547ad92)\)
