...
-   *eCommandId* Enumeration indicating the command to be sent \(see above and [Section 45.8.3](server_command_id_enumerations.md#id_953b6d1f-bde2-4fb3-85c4-a02ea62c8aaf)\)
-   *bApplianceStatusTwoPresent* Boolean indicating whether additional appliance status data is present in payload:
    -   TRUE - Present
    -   FALSE - Not present
-   *psPayload* Pointer to structure containing payload for message \(see above and [Section 45.9.3](tscld_ac_signalstateresponseorsignalstatenotificat.md#id_62cbbba6-9e68-43f7-8ffc-b7f9112099d1)\)
