...
| Bits | Status                                                                                                           |
| ---- | ---------------------------------------------------------------------------------------------------------------- |
| 0    | Ballast operational status: 0: Ballast is fully operational<br>1: Ballast is not fully operational               |
| 1    | Lamp status:<br>0: All associated lamps are in their sockets<br>1: Not all associated lamps are in their sockets |
| 2-7  | Reserved                                                                                                         |
...
| Bits | Alarm Trigger                                                                                                                     |
| ---- | --------------------------------------------------------------------------------------------------------------------------------- |
| 0    | Alarm triggered when u32LampBurnHours reaches u32LampBurnHoursTripPoint:<br>0: Alarm trigger disabled<br>1: Alarm trigger enabled |
| 1-7  | Reserved                                                                                                                          |
