...
The table below shows that the initial client binaries to be programmed into the MCXW71, and MCXW72 devices are version 1 files.
...
| FRDM-MCXW72 board | •  `frdmmcxw72_zigbee_router_freertos_v1.axf`<br>•  `frdmmcxw72_zigbee_ed_rx_on_freertos_v1.axf`<br>•  `frdmmcxw72_zigbee_ed_rx_off_freertos_v1.axf`
| MCX-W71-EVK board | •  `mcxw71evk_zigbee_router_bm_v1.axf`<br>•  `mcxw71evk_zigbee_ed_rx_on_bm_v1.axf`<br>•  `mcxw71evk_zigbee_ed_rx_off_bm_v1.axf`<br>•  `mcxw71evk_zigbee_router_freertos_v1.axf`<br>•  `mcxw71evk_zigbee_ed_rx_on_freertos_v1.axf`<br>•  `mcxw71evk_zigbee_ed_rx_off_freertos_v1.axf`                                                   |
...
| FRDM-MCXW72 board | •  `frdmmcxw72_zigbee_router_freertos_v2.ota`<br>•  `frdmmcxw72_zigbee_router_freertos_v3.ota`<br>•  `frdmmcxw72_zigbee_ed_rx_on_freertos_v2.ota`<br>•  `frdmmcxw72_zigbee_ed_rx_on_freertos_v3.ota`<br>•  `frdmmcxw72_zigbee_ed_rx_off_freertos_v2.ota`<br>•  `frdmmcxw72_zigbee_ed_rx_off_freertos_v3.ota`
| MCX-W71-EVK board | •  `mcxw71evk_zigbee_router_bm_v2.ota`<br>•  `mcxw71evk_zigbee_router_bm_v3.ota`<br>•  `mcxw71evk_zigbee_ed_rx_on_bm_v2.ota`<br>•  `mcxw71evk_zigbee_ed_rx_on_bm_v3.ota`<br>•  `mcxw71evk_zigbee_ed_rx_off_bm_v2.ota`<br>•  `mcxw71evk_zigbee_ed_rx_off_bm_v3.ota`<br>•  `mcxw71evk_zigbee_router_freertos_v2.ota`<br>•  `mcxw71evk_zigbee_router_freertos_v3.ota`<br>•  `mcxw71evk_zigbee_ed_rx_on_freertos_v2.ota`<br>•  `mcxw71evk_zigbee_ed_rx_on_freertos_v3.ota`<br>•  `mcxw71evk_zigbee_ed_rx_off_freertos_v2.ota`<br>•  `mcxw71evk_zigbee_ed_rx_off_freertos_v3.ota` |
