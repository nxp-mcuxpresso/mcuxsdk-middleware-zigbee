...
typedef enum
{
    ...
    ZPS_NWK_ENUM_INVALID_INTERFACE,           /**< MAC interface disabled or unknown (0xd5) */
#ifdef R23_UPDATES
    ZPS_NWK_ENUM_MISSING_TLV,                 /**< Required TLV missing in the request (0xd6) */
    ZPS_NWK_ENUM_INVALID_TLV,                 /**< Required TLV malformed in the request (0xd7) */
#endif
} ZPS_teNwkEnum;
