                    ...
                    tsZCL_ClusterInstance      *psClusterInstance)
{
    ...
    if (sZCL_CallBackEvent.eEventType != E_ZCL_CBET_ERROR)
    {
        ...
        // written attributes, to save bandwidth. In the case of successful writing
        // of all attributes, only a single write attribute status record SHALL be
        // included in the command, with the status field set to SUCCESS and the
