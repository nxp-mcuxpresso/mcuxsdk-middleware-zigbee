...
/***        External Functions                                            ***/
/****************************************************************************/
extern PUBLIC void APP_vPostToZclQueue(void *pvMessage);
extern PUBLIC void APP_vPostToAppQueue (void *pvMsg);
extern PUBLIC void APP_vPostToAppQueueWord (uint8 u8MsgType);
